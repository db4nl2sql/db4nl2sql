# copied from BIRD-bench
# https://github.com/AlibabaResearch/DAMO-ConvAI/blob/main/bird/llm/run/run_evaluation_ves.sh
# We excluded "without knowledge" since we always use evidence.

db_root_path='./data/dev_databases/'
data_mode='dev'
diff_json_path='./data/dev.json'
predicted_sql_path_kg='./exp_result/'
